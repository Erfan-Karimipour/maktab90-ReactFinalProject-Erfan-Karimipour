...
export const ProductSection = (cat) => {
  ...
  return (
    <div className='grid grid-cols-5 mt-1 w-[90rem] mx-auto px-10 border-t'>

        {products.map((product) => (

            <div className='flex flex-col border border-t-0 border-gray-200 items-center py-4 h-[20rem] hover:shadow-lg duration-150 cursor-pointer m-auto' key={product._id}>
