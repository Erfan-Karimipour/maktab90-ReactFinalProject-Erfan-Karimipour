  ...
  return (
    ...
    <div className='grid grid-cols-5 mt-1 w-[90rem] mx-auto px-10 border-t gap-1'>
        ...
        {products.map((product) => (
          ...
          <a className='flex flex-col border border-gray-200 items-center py-4 h-fit hover:shadow-xl duration-150 cursor-pointer m-auto hover:border hover:border-red-500' key={product._id} onClick={() => {window.open(`http://localhost:5555/product/${product._id}`, `_blank`)}} >
